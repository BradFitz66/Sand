...
local particles={
    ...
    {"SAND",{(255)/255,204/255,128/255},function(x,y,s,c) return update_sand(x,y,s,c) end,1},
    {"WALL",{100/255,100/255,100/255},function(x,y,s,c) return x,y end,0},
    {"WATER",{116/255,204/255,244/255},function(x,y,s,c) return update_water(x,y,s,c) end,1}
}
